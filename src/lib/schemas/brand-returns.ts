...
// Mirror of organizationReturnsSchema — values land on `brands.*`
// (see migration 20260426000001) for rep-org manual brands.
export const brandReturnsSchema = z
	.object({
		windowDays: z.coerce
...
export type BrandReturnsInput = z.infer<typeof brandReturnsSchema>;
