...
export const organizationTaxesSchema = z.object({
...
export type OrganizationTaxesInput = z.infer<typeof organizationTaxesSchema>;
...
export type SalesTaxRateInput = z.infer<typeof salesTaxRateSchema>;
