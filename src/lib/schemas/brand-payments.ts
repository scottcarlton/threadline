...
// Mirror of organizationPaymentsSchema — values land on `brands.*`
// (see migration 20260426000001) for rep-org manual brands.
export const brandPaymentsSchema = z
	.object({
...
export type BrandPaymentsInput = z.infer<typeof brandPaymentsSchema>;
