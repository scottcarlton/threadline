...
// Mirror of organizationShippingSchema — values land on `brands.*`
// (see migration 20260426000001) for rep-org manual brands.
export const brandShippingSchema = z
	.object({
...
export type BrandShippingInput = z.infer<typeof brandShippingSchema>;

// Row in `brand_shipping_methods`.
export const brandShippingMethodSchema = z
	.object({
...
export type BrandShippingMethodInput = z.infer<typeof brandShippingMethodSchema>;
