...
>
	...
	{#if showFilterToggle}
		<div class="relative mr-1 shrink-0 overflow-visible">
			<button
				onclick={onFilterToggle}
				class="flex min-h-[44px] items-center justify-center rounded-sm border border-input bg-background px-3 transition-colors hover:bg-muted/50"
