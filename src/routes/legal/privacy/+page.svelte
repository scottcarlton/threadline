...
<svelte:head>
	<title>Privacy Policy — Threadline</title>
</svelte:head>
	...
	<div class="mt-10 space-y-8 text-base leading-relaxed text-muted-foreground">
		...
		<section>
			...
			<ul class="list-disc space-y-1 pl-5">
				...
				<li>Business data: orders, accounts, contacts, brands, commissions</li>
				<li>Communications: emails and messages sent through the Service</li>
				<li>Support requests and feedback</li>
			</ul>

			<h3 class="mt-3 mb-1 font-medium text-foreground">Information collected automatically</h3>
			<ul class="list-disc space-y-1 pl-5">
		...
		<section>
			...
			<ul class="mt-2 list-disc space-y-1 pl-5">
				<li>
					<strong>Service providers:</strong> third-party vendors who assist in operating the Service
					(hosting, email delivery, analytics, error tracking), bound by confidentiality obligations
				</li>
				<li>
					<strong>Connected organizations:</strong> when you connect your organization to another on the
					platform, limited business data is shared as described in the product
				</li>
				<li>
		...
		<section>
			...
			<p>
				...
				child under 16, we will delete it promptly.
			</p>
		</section>
