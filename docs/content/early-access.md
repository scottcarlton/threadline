# Threadline — Early Access Landing Page Content Draft
...
## SECTION 6 — FAQ (Early Access Specific)
...
A: We're limiting Early Access to 50 organizations to ensure every member gets hands-on support from the founding team.

**Q: Is Early Access free?**
A: Yes. Early Access is free for the first 30 days. After that, founding members lock in a discounted rate for as long as they stay on Threadline.

**Q: What happens after Early Access?**
A: Beta opens in late May, and full public launch is June 30. Early Access members keep their founding pricing and get priority access to every new feature.

**Q: Can I invite my team?**
A: Yes. Invite team members during Early Access at no additional cost. Your entire org can use the platform from day one.
